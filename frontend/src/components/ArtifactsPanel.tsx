...
export default function ArtifactsPanel({
  ...
  return (
    <aside data-testid="artifacts-panel" className="hidden w-64 shrink-0 border-r border-white/10 bg-black/25 md:flex md:flex-col">
      ...
      <section className="flex min-h-0 flex-1 flex-col px-3 pb-3 pt-4">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto">
          {loading ? (
            ...
            <p className="py-6 text-center text-xs text-app-muted/75">
              Deliverables appear here after each agent run.
            </p>
          ) : (
